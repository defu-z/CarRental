...
const Footer = () => {
  return (
    <div id="footer" className='bg-gray-100 dark:bg-dark mt-14 rounded-t-3xl'>
        <div className="contarner">
            ...
            >
                ...
                {/* {navbar links} */}
                <div className='grid grid-clos-2 sm:grid-cols-3 col-span-2 md:pl-10'>
                    {/* {first clos} */}
                    <div>
                        <div className='py-8 px-4'>
                    ...
                    <div>
                        <div className='py-8 px-4'>
                            <h1 className='text-xl  font-bold sm:text-left text-justify mb-3'>Explore</h1>
                            <ul className='flex flex-col gap-3'>
                                {
                                   FooterLinks.map((data)=>{
                                    return(
