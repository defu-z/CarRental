...
const skillsData = [
    {
        ...
        icon: (
            <SiPersonio className="text-5xl text-primary group-hover:text-black duration-300" />
        ),
        link: "#",
    ...
    },
    {
        ...
        icon: (
            <SiOnlyoffice className="text-5xl text-primary group-hover:text-black duration-300" />
        ),
        link: "#",
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    {skillsData.map((skill) => (
                        ...
                        >
                            ...
                            <a href={skill.link}
                            className="inline-block text-lg font-semibold py-3 text-primary group-hover:text-black duration-300">Learn more</a>
                        </div>
                    ))}
                </div>
            </div>
